...
public class DataProvider {
  ...
  public static List<Hospital> getHospitals() {
    ...
    list.add(
        new Hospital(
            ...
            "+977-056-123456",
            "https://cmc.edu.np",
            "A leading medical college and hospital in Chitwan.",
            4.6,
            null));
    list.add(
        new Hospital(
            ...
            "+977-01-5199600",
            "https://bpkihs.edu",
            "One of the largest private hospitals in Nepal.",
            4.5,
            null));
    return list;
  }
  ...
  public static MedicalHistory getMedicalHistory(String patientName) {
    ...
    timeline.add(
        new MedicalHistoryEntry(
            "02 Mar 2026", "Chest Pain", "ECG performed. No major abnormalities found."));
  ...
  public static List<TimeSlot> getTimeSlots() {
    ...
    for (int i = 0; i < times.length; i++) {
      list.add(new TimeSlot(i, times[i], times[i], available[i]));
    }
    return list;
  }
